...
if(isset($_GET['del'])):
  ...
  header("Location: index_dynamika.php");
...
<h2>Dynamika èástice - obtížné otázky</h2>
...
<?php
      ...
      if($kolik>-1):
        ...
        if(isset($_GET['akce'])) include $root."/Testy_dynamika/".$indexer[$random];
