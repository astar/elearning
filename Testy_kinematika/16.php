...
<td width="400px" class="test2">Velikost rychlosti částice, jejíž  zrychlení roste, se zvyšuje.                                                                                  
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka2"> (b)</td>
<td width="400px" class="test2">Velikost rychlosti částice, která se pohybuje s konstantním zrychlením, může být konstantní.                                       
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka3"> (c)</td>
<td width="400px" class="test2">Pokud je velikost zrychlení částice konstantní a nenulová, je pohyb částice nerovnoměrný.                                                                                                           
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka4"> (d)</td>
<td width="400px" class="test2">Částice může mít nulovou rychlost a nenulové zrychlení.                                           
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2">Při křivočarém pohybu nemůže být normálové
      zrychlení částice v žádném okamžiku nulové.
</td>
</tr>
