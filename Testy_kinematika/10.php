<strong>Na obrázku je zakreslen graf závislosti velikosti rychlosti částice na čase. Z následujících tvrzení je právě jedno správné. Vyberte jej.</strong>
...
<td width="400px" class="test2">V intervalu [10,11] s může dráha částice klesat.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka2"> (b)</td>
<td width="400px" class="test2">V intervalu [6,9] s může mít částice nenulové zrychlení.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka3"> (c)</td>
<td width="400px" class="test2">V intervalu [13,14] s může dráha částice narůstat.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka4"> (d)</td>
<td width="400px" class="test2">V intervalu [4,5] s může mít částice nulové zrychlení.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2">V intervalu [1,2] s může mít částice nenulové zrychlení.</td>
</tr>
