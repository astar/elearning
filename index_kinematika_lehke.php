...
if(isset($_GET['del'])):
  ...
  header("Location: index_kinematika_lehke.php");
...
if(isset($_GET['akce'])):
  ...
  $adresar=dir("./Testy_kinematika_lehke/");
...
<h2>Kinematika částice - lehké otázky</h2>
...
<?php
      ...
      if($kolik>-1):
        ...
        if(isset($_GET['akce'])) include $root."/Testy_kinematika_lehke/".$indexer[$random];
