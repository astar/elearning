...
Vyberte právì ta tvrzení, která jsou správná.</strong></div>
...
<td width="400px" class="test2">Po celou dobu, kdy je bedna vzhledem k jedoucímu vagónu v klidu, na ni pùsobí statická tøecí síla o velikosti amath m g f_0 endamath. Tato síla je orientovaná ve smìru pohybu vagónu.</td>
</tr>
...
<td width="400px" class="test2">Do okamžiku amath t = t_0 endamath, kdy se vagón zaène rozjíždìt, je statická tøecí síla pùsobící na bednu nulová.
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka4"> (d)</td>
<td width="400px" class="test2">Velikost statické tøecí síly pùsobící na bednu roste spolu se zrychlením vagónu až do hodnoty amath m g f_0 endamath. Tato síla má opaènou orientaci než zrychlení vagónu.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2">V okamžiku amath t = t_0 endamath nabývá statická tøecí síla pùsobící na bednu velikosti amath m g f_0 endamath a bedna se zaèíná vzhledem k vagónu pohybovat.</td>
</tr>
