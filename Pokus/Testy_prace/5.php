<div id="otazka"><strong>Mezi dvìma èásticemi (hmotnými body) o rùzných hmotnostech, které tvoøí izolovanou soustavu, došlo k pøímé pružné srážce (pøi pøímé srážce leží poèáteèní rychlosti èástic v jedné pøímce).  Srážku popisujeme v laboratorní (inerciální) vztažné soustavì. Z následujících tvrzení je právì jedno správné. Vyberte je.
</strong></div>
