<div id="otazka"><strong>Z následujících zápisů vyberte právě ty, které mohou být fyzikálně správné.</strong></div>
...
<td width="400px" class="test2">amath vec bb r = (0,r) endamath</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka2"> (b)</td>
<td width="400px" class="test2">amath vec bb g endamath = 9,8 m.s<sup>-2</sup></td>
</tr>
...
<td width="400px" class="test2">amath vec bb F_1\ -\ vec bb F_2\ = m vec bb a endamath</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2"><i>F</i> =  (F</i><sub>1</sub>, <i>F</i><sub>2</sub>)</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka6"> (f)</td>
<td width="400px" class="test2">amath vec bb F = ( vec bb F sin alpha, vec bb F cos alpha ) endamath</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka7"> (g)</td>
<td width="400px" class="test2">amath vec bb F endamath = <i>m.a</i></td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka8"> (h)</td>
<td width="400px" class="test2">amath W = vec bb F ** vec bb s endamath</td>
</tr>
</table>
<br>
