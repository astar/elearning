<div id="otazka"><strong>Z následujících fyzikálních veličin vyberte právě ty, které jsou skalární.</strong></div>
...
<td width="400px" class="test2">Průmět síly do osy <i>x</i> zvolené soustavy souřadnic.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka3"> (c)</td>
<td width="400px" class="test2">Rychlost částice při přímočarém pohybu.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka4"> (d)</td>
<td width="400px" class="test2"><i>Z</i>-ová souřadnice polohy částice ve zvolené soustavě souřadnic.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2">Velikost tečného zrychlení částice.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka6"> (f)</td>
<td width="400px" class="test2">Změna polohového vektoru částice.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka7"> (g)</td>
<td width="400px" class="test2">Moment setrvačnosti tělesa vzhledem k dané ose otáčení.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka8"> (h)</td>
<td width="400px" class="test2">Polohový vektor částice, která je v počátku dané soustavy souřadnic v klidu.</td>
</tr>
</table>
<br>
