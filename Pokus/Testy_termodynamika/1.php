<div id="otazka"><strong>Z následujících tvrzení vyberte právě ta, která jsou pro ideální plyn obecně správná.
</strong></div>
...
<td width="400px" class="test2">Pokud se teplota plynu nemění, nemění se ani jeho vnitřní energie.
</td>
</tr>
...
<td width="400px" class="test2">Pokud roste teplota plynu, přijímá plyn od okolí kladné teplo.
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka7"> (g)</td>
<td width="400px" class="test2">Pokud se plyn rozpíná, klesá jeho vnitřní energie.
</td>
</tr>
...
<script>
	function vyhodnoceni(){
		...
		if (document.form.otazka1.checked==false &&
			...
			window.open("Spatne/termodynamika/spravne1.htm","Spravne", "height=170px, width=500px, top=300px, left=500px, status=no, toolbar=no, location=no, scrollbars=yes, resizable=no");
		else 
	     
			window.open("Spatne/termodynamika/spatne1.htm","Spatne", "height=170px, width=500px, top=300px, left=500px, status=no, toolbar=no, location=no, scrollbars=yes, resizable=no");
