...
if(isset($_GET['del'])):
  ...
  header("Location: index_vektory.php");
...
<h2>Skalární a vektorové velièiny</h2>
...
<?php
      ...
      if($kolik>-1):
        ...
        if(isset($_GET['akce'])) include $root."/Testy_vektory/".$indexer[$random];
