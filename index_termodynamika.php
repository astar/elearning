...
if(isset($_GET['del'])):
  ...
  header("Location: index_termodynamika.php");
...
if(isset($_GET['akce'])):
  ...
  $adresar=dir("./Testy_termodynamika/");
...
<h2>Základy termodynamiky a statistické fyziky</h2>
...
<?php
      ...
      if($kolik>-1):
        ...
        if(isset($_GET['akce'])) include $root."/Testy_termodynamika/".$indexer[$random];
