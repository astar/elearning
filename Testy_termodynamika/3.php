<strong>Z následujících tvrzení vyberte právì to, které je obecnì správné.
</strong>
...
<td width="400px" class="test2">Pøi dané teplotì má polovina molekul plynu menší velikost rychlosti, než je støední velikost rychlosti molekul.
</td>
</tr>
...
<td width="400px" class="test2">Pokud se sníží teplota plynu, klesne poèet molekul s danou velikostí rychlostí.
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2">Pøi dané teplotì plynu se velikost rychlosti jednotlivých molekul plynu nemìní.
</td>
</tr>
