...
if(isset($_GET['del'])):
  ...
  header("Location: index_vektory_lehke.php");
...
if(isset($_GET['akce'])):
  ...
  $adresar=dir("./Testy_vektory_lehke/");
...
<h2>Skalární a vektorové veličiny</h2>
...
<?php
      ...
      if($kolik>-1):
        ...
        if(isset($_GET['akce'])) include $root."/Testy_vektory_lehke/".$indexer[$random];
