...
<td width="400px" class="test2">Po celou dobu, kdy je bedna vzhledem k jedoucímu vagónu v klidu, na ni působí statická třecí síla o velikosti <i>mgf</i><sub>0</sub>. Tato síla je orientovaná ve směru pohybu vagónu.</td>
</tr>
...
<td width="400px" class="test2">Do okamžiku <i>t</i>=<i>t</i><sub>0</sub>, kdy se vagón začne rozjíždět, je statická třecí síla působící na bednu nulová.
</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka4"> (d)</td>
<td width="400px" class="test2">Velikost statické třecí síly působící na bednu roste spolu se zrychlením vagónu až do hodnoty <i>mgf</i><sub>0</sub>. Tato síla má opačnou orientaci než zrychlení vagónu.</td>
</tr>

<tr>
<td width="50px" class="test"><input type="checkbox" name="otazka5"> (e)</td>
<td width="400px" class="test2">V okamžiku <i>t</i>=<i>t</i><sub>0</sub> nabývá statická třecí síla působící na bednu velikosti  <i>mgf</i><sub>0</sub> a bedna se začíná vzhledem k vagónu pohybovat.</td>
</tr>
